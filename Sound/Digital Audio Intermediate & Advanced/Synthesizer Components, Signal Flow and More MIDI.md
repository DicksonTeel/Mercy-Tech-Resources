- VCO - Voltage Control Oscillator (The thing that makes the sound) —> VCF - Voltage Control Filter (fucks with the sound) —> VCA - Voltage Control Amplifier (outputs the sound).
